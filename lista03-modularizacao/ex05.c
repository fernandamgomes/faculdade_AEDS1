/* 
Fernanda Mendes Gomes (17/09/2021) // (20/09/2021)
...
// procedimento que recebe a media, identifrica e exibe o conceito
void conceito(float media)
{
    // analisar e imprimir conceito baseado no valor de media recebido pelo procedimento
    printf("Conceito: "); 
    if (media <= 39) 
    {
        printf("F\n"); 
